...
gdown.download_folder(url, quiet=False, output=f"/Volumes/{CATALOG}/{SCHEMA_BASE}/raw")
...
for scale in scales:
    ...
    for table_fn in tables:
        create_table_no_deletion_vectors(spark=spark, scale_path=SCALE_PATH,
                             catalog=CATALOG, schema=schema,
                             table_fn=table_fn, scale=scale)
